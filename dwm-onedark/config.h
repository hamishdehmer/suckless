...
static const char *fonts[] = {
    "JetBrainsMono Nerd Font Mono:size=12", "Noto Color Emoji:size=12",
    "Font Awesome 5 Brands:size=18", "Font Awesome 5 Free:size=18",
    "FontAwesome:size=18"};
// dmenu
...
// Theme
static const char bg[] = "#282a2e"; // Background
...
/* quitting */
static const int EMPTY_WINDOW_COUNT = 999;
